      ...
      'customers',
      {
        ...
        columns: [
          ...
          },
          {
            ...
            hasDefault: true,
            defaultValue: 'NOW()',
            description: 'Account creation date (DEFAULT NOW())',
          },
          {
            name: 'arr',
            type: { kind: 'number' },
            ...
            hasDefault: true,
            defaultValue: 0,
            description: 'Annual recurring revenue in USD (DEFAULT 0)',
          },
        ],
      },
    ],
      ...
      'products',
      {
        ...
        columns: [
          ...
          },
          {
            ...
            hasDefault: true,
            defaultValue: true,
            description: 'Whether product is currently sold (DEFAULT true)',
          },
        ],
      },
    ],
      ...
      'orders',
      {
        ...
        columns: [
          ...
          },
          {
            ...
            hasDefault: true,
            defaultValue: 'NOW()',
            description: 'When order was placed (DEFAULT NOW())',
          },
          {
            name: 'completed_at',
            type: { kind: 'datetime' },
      ...
      'support_tickets',
      {
        ...
        columns: [
          ...
          },
          {
            ...
            hasDefault: true,
            defaultValue: 'NOW()',
            description: 'When ticket was opened (DEFAULT NOW())',
          },
          {
            name: 'resolved_at',
            type: { kind: 'datetime' },
      ...
      'email_log',
      {
        ...
        columns: [
          ...
          },
          {
            ...
            hasDefault: true,
            defaultValue: 'NOW()',
            description: 'Timestamp when email was sent (DEFAULT NOW())',
          },
          {
            name: 'provider',
            type: { kind: 'string' },
